            ...
            <div class="col-lg-12 mb-1 mb-sm-1">
                <div class="card-body p-1-9 p-sm-2-3 p-md-6 p-lg-6">
                    <div class="col-lg-6 px-xl-10">
                        <h3 class="h2 text-black mb-0">DATA BERHASIL DISIMPAN</h3><br>
                        <?php
                        include 'koneksi.php';
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            $sql = "INSERT INTO tb_formulir (Nama, Nim, Status, Program_Studi, Hobi, Email, Alamat, No_HP)
                            VALUES ('$nama', '$nim', '$status', '$program_studi', '$hobi', '$email', '$alamat', '$no_hp')";
